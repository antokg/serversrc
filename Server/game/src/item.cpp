...
bool CItem::EquipTo(LPCHARACTER ch, BYTE bWearCell)
{
	...
	else
	{
		...
		if (ITEM_LIMIT_MAX_NUM != GetProto()->cLimitTimerBasedOnWearIndex)
...
void CItem::SetSockets(const int * c_al)
{
...
bool CItem::OnAfterCreatedItem()
{
	...
	if (ITEM_LIMIT_MAX_NUM != this->GetProto()->cLimitRealTimeFirstUseIndex)
	{
